        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Co2Factor = table.Column<double>(type: "float", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DeletedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ConsumptionRecords_ConsumptionTypes_ConsumptionTypeId",
                        column: x => x.ConsumptionTypeId,
                        principalTable: "ConsumptionTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ConsumptionRecords_Facilities_FacilityId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Recommendations_Facilities_FacilityId",
                        column: x => x.FacilityId,
                        principalTable: "Facilities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ConsumptionRecords_ConsumptionTypeId",
                table: "ConsumptionRecords",
                column: "ConsumptionTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_ConsumptionRecords_FacilityId",
                table: "ConsumptionRecords",
                column: "FacilityId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Recommendations_FacilityId",
                table: "Recommendations",
                column: "FacilityId");
